        ...
        <main className="govuk-main-wrapper" id="main-content" role="main">
          ...
          <div className="govuk-tabs" data-module="govuk-tabs">
            ...
            {props?.isDeveloper && props?.showDeveloperTab ? (
              <Tabs
                tabs={[
                  { label: props.t('developer.heading'), id: 'developer' },
                  { label: props.t('consumer_view.data'), id: 'data' },
                  { label: props.t('consumer_view.about_this_dataset'), id: 'about_dataset' },
                  { label: props.t('consumer_view.download'), id: 'download_dataset' }
                ]}
              />
            ) : (
              <Tabs
            ...
            {props?.isDeveloper && props?.showDeveloperTab && <DeveloperView {...props} />}

            <div className="govuk-tabs__panel" id="data" role="tabpanel" aria-labelledby="tab_data">
              <div className="govuk-width-container">
                  ...
                  >
                      ...
                      <fieldset className="govuk-fieldset">
                        <legend className="govuk-fieldset__legend govuk-fieldset__legend--l">
                          <h2 className="govuk-fieldset__heading govuk-heading-m">
                            {props.t('consumer_view.download_heading')}
                          </h2>
                        </legend>
                    ...
                    <div className="govuk-form-group">
                      <fieldset className="govuk-fieldset">
                        <legend className="govuk-fieldset__legend govuk-fieldset__legend--l">
                          <h2 className="govuk-fieldset__heading govuk-heading-m">
                            {props.t('consumer_view.download_format')}
                          </h2>
                        </legend>
                        <div className="govuk-radios" data-module="govuk-radios">
                          <div className="govuk-radios__item">
                    ...
                    <div className="govuk-form-group">
                      <fieldset className="govuk-fieldset">
                        <legend className="govuk-fieldset__legend govuk-fieldset__legend--l">
                          <h2 className="govuk-fieldset__heading govuk-heading-m">
                            {props.t('consumer_view.number_formating')}
                          </h2>
                        </legend>
                        <div className="govuk-radios" data-module="govuk-radios">
                          <div className="govuk-radios__item">
                    ...
                    <div className="govuk-form-group">
                      <fieldset className="govuk-fieldset">
                        <legend className="govuk-fieldset__legend govuk-fieldset__legend--l">
                          <h2 className="govuk-fieldset__heading govuk-heading-m">
                            {props.t('consumer_view.select_language')}
                          </h2>
                        </legend>
                        <div className="govuk-radios" data-module="govuk-radios">
                          <div className="govuk-radios__item">
