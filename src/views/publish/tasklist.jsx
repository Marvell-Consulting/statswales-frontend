          ...
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-two-thirds">
                  ...
                  <li className="govuk-task-list__item govuk-task-list__item--with-link">
                    <div className="govuk-task-list__name-and-hint">
                      <a
                        className="govuk-link govuk-task-list__link"
                        href={props.buildUrl(
                          `/publish/${props.datasetId}/dimension/${dimension.id}`,
                          props.i18n.language
                        )}
                      >
                        {dimension.name}
              ...
              <h2 className="govuk-heading-l govuk-!-margin-top-5">
                {props.t('publish.tasklist.metadata.subheading')}
              </h2>
              <ul className="govuk-task-list">
                <TasklistItem
                  id="title"
              ...
              <h2 className="govuk-heading-l govuk-!-margin-top-5">
                {props.t('publish.tasklist.translation.subheading')}
              </h2>
              <ul className="govuk-task-list">
                <li className="govuk-task-list__item govuk-task-list__item--with-link">
                  <div className="govuk-task-list__name-and-hint">
              ...
              <h2 className="govuk-heading-l govuk-!-margin-top-5">
                {props.t('publish.tasklist.publishing.subheading')}
              </h2>
              <ul className="govuk-task-list">
                <TasklistItem
              ...
              {props.canSubmit && (
                <div>
                  <h2 className="govuk-heading-l govuk-!-margin-top-5">
                    {props.t('publish.tasklist.submit.subheading')}
                  </h2>
