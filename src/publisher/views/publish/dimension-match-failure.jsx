  ...
  return (
    <Layout {...props} backLink={backLink} returnLink={returnLink} title={title}>
      ...
      {props.extension.nonMatchingDataTableValues && (
        <>
          <h2 className="govuk-heading-l">{props.t('publish.dimension_match_failure.missing_data_table_values')}</h2>
      ...
      {props.extension.nonMatchedLookupValues && (
        <>
          <h2 className="govuk-heading-l">{props.t('publish.dimension_match_failure.missing_lookup_table_values')}</h2>
