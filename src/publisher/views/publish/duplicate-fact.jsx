...
export default function DuplicateFact(props) {
  const duplicateCount = props.data?.length || 0;
  let title = props.t('errors.fact_table_validation.duplicate_fact_missing');

  if (duplicateCount > 499) {
    title = props.t('errors.fact_table_validation.duplicate_fact_500', { count: duplicateCount });
  } else if (duplicateCount) {
    title = props.t('errors.fact_table_validation.duplicate_fact', { count: duplicateCount });
  }
