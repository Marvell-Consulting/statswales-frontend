...
export default merge({}, en, {
  ...
  developer_warning:
    '<strong class="govuk-tag govuk-tag--red govuk-phase-banner__content__tag">Warning</strong> Tudalen y datblygwr yw hon ac nid yw wedi bod trwy waith ymchwil gyda defnyddwyr',
  developer_tag:
  ...
  header: {
    ...
    beta: 'Beta',
    feedback:
      'Rydych chi\'n edrych ar fersiwn newydd o StatsCymru.  Gallwch gael cymorth trwy droi at <a class="govuk-link" href="http://statswales3support.slack.com">Slack</a>.',
  ...
  login: {
    ...
    form: {
      notice_1:
        "Mae'r enw defnyddiwr a roddwyd i chi yn enw defnyddiwr dros dro.  Dim ond yn ystod y cyfnod profi hwn y byddwch yn gallu ei ddefnyddio i fewngofnodi.",
      notice_2:
        'Peidiwch â lanlwytho unrhyw ddata sensitif neu ddata na ddylai defnyddwyr eraill StatsCymru gael mynediad iddo.',
      username: {
  ...
  publish: {
    ...
    start: {
      ...
      data_table:
        "tabl data sy'n cynnwys gwerthoedd data a chyfeiriadau at yr holl ddimensiynau perthnasol",
      lookup_table:
        'unrhyw dablau am-edrych a gynhyrchir gan y defnyddiwr, y mae angen i chi eu cynnwys (os yn berthnasol)',
    ...
    time_dimension_chooser: {
      ...
      chooser: {
        ...
        'period-hint':
          "Er enghraifft, misoedd neu flynyddoedd y mae'r gwerthoedd data yn berthnasol iddynt",
    ...
    measure_match_failure: {
      ...
      information:
        "Nid oes {{failureCount, number}} cyfeiriad yn y dimensiwn yn cyd-fynd â'r cyfeiriadau yn eich tabl am-edrych mesur.  Dylech wirio:",
    ...
    dimension_match_failure: {
      ...
      lookup_information:
        "Nid oes {{failureCount, number}} cyfeiriad yn y dimensiwn yn cyd-fynd â'r cyfeiriadau yn eich tabl am-edrych.  Dylech wirio:",
      ref_information:
        'Nid oes {{failureCount, number}} cyfeiriad yn y dimensiwn yn cyd-fynd â chategori y data cyfeirio a ddewisoch.  Dylech wirio:',
    ...
    period_match_failure: {
      ...
      information:
        "Nid oes {{failureCount, number}} cod dyddiad yn y dimensiwn yn cyd-fynd â'r fformat dyddiadau a nodoch.  Dylech wirio:",
      ...
      form: {
        title: {
          ...
          error: {
            ...
            unique:
              "Mae'r teitl a nodwyd yn cael ei ddefnyddio yn barod ar gyfer set ddata a gyhoeddwyd.  Nodwch deitl unigryw ar gyfer y set ddata hon."
          }
        }
      }
    },
    ...
    quality: {
      ...
      explain_1:
        "unrhyw faterion neu newidiadau methodolegol sy'n ymwneud â'r set ddata hon, gan gynnwys unrhyw:",
      explain_1a: "nodiadau sy'n berthnasol i'r holl werthoedd data yn y set ddata hon",
      explain_1b:
        "esboniadau wedi'u haddasu sy'n angenrheidiol er mwyn egluro unrhyw godau nodiadau a ddefnyddiwyd",
      ...
      form: {
        ...
        rounding_description: {
          label:
            'Mewn brawddegau syml a byr, esboniwch pa waith talgrynnu sydd wedi cael ei wneud.',
          error: {
    ...
    update_frequency: {
      ...
      form: {
        ...
        frequency_value: {
          ...
          error: {
            missing:
              "Nodwch nifer yr wythnosau, y misoedd neu'r blynyddoedd ar gyfer y cyfnod rhwng diweddariadau"
          }
        },
        frequency_unit: {
          options: {
          ...
          error: {
            missing:
              "Nodwch a yw'r cyfnod rhwng diweddariadau mewn wythnosau, misoedd neu flynyddoedd"
          }
        }
      }
    },
      ...
      add: {
        ...
        form: {
          ...
          link_label: {
            ...
            error: {
              missing:
                'Nodwch destun y ddolen i ymddangos ar y dudalen we am adroddiad cysylltiedig'
            }
          }
        }
      },
    ...
    providers: {
      add: {
        ...
        explain:
          'Os nad ydych chi\'n gallu dod o hyd i ddarparwr y data yn y rhestr, gallwch <a class="govuk-link" href="{{request_data_provider_url}}">ofyn bod darparwr data yn cael ei ychwanegu</a>.',
        form: {
          provider: {
      ...
      add_source: {
        ...
        form: {
          has_source: {
            ...
            error: {
              missing:
                "Dewiswch a ydych chi'n dymuno dewis ffynhonnell neu nodi nad oes ffynhonnell benodol gan y darparwr data"
            }
          },
          source: {
            ...
            error: {
              missing:
                'Dewis ffynhonnell o restr y ffynonellau ar gyfer y darparwr data a ddewiswyd'
            }
          }
        }
      },
    ...
    preview: {
      ...
      row_number: 'Rhes',
      preview_summary:
        'Mae eich lanlwythiad yn cynnwys $t(publish.preview.columns, {"count": {{cols}} }) a $t(publish.preview.rows, {"count": {{rows}} }).',
      columns_rows:
        '$t(publish.preview.columns, {"count": {{cols}} }) a $t(publish.preview.rows, {"count": {{rows}} })',
      upload_summary:
        'Mae\'r tabl data yn cynnwys $t(publish.preview.columns, {"count": {{cols}} }) a $t(publish.preview.rows, {"count": {{rows}} }).  Mae $t(publish.preview.columns, {"count": {{ignored}} }) yn y lanlwythiad CSV wedi cael eu hanwybyddu.',
    ...
    tasklist: {
      ...
      submit: {
        subheading:
          "Trwy barhau, rydych chi'n cadarnhau bod yr holl ddata a'r metadata wedi cael ei wirio a'i fod yn gywir.",
    ...
    change_data: {
      ...
      change_columns: {
        ...
        description:
          "Bydd hyn yn gwaredu data cyfeirio ar gyfer unrhyw golofnau sy'n cynnwys dimensiynau y byddwch yn eu newid"
      }
    },
    point_in_time: {
  ...
  developer: {
    ...
    list: {
      ...
      error: {
        no_datasets:
          "Nid oes unrhyw setiau data wedi'u rhestru yn y gronfa ddata ar hyn o bryd.  Os oes angen help arnoch, holwch aelod o'r tîm datblygu."
      }
    },
    display: {
  ...
  errors: {
    confirm: {
      missing:
        "Mae angen i chi gadarnhau neu wrthod y ffeil a lanlwythwyd gan ddefnyddio'r botymau ar ddiwedd y rhagolwg"
    },
    session: {
      ...
      no_sources_on_import:
        "Nid yw'r mewngludiad cyfredol yn cynnwys unrhyw ffynonellau, a oedd y CSV yn wag?"
    },
    sources: {
      unknowns_found: 'Mae angen i chi ddweud wrthym beth mae pob colofn yn ei gynnwys',
      multiple_datavalues:
        "Dim ond un golofn y gallwch ei nodi fel un sy'n cynnwys gwerthoedd data",
      multiple_footnotes: "Dim ond un golofn y gallwch ei nodi fel un sy'n cynnwys nodiadau",
      dimension_creation_failed:
        "Aeth rhywbeth o'i le wrth geisio creu'r dimensiynau.  Rhowch gynnig arall arno."
    },
    preview: {
      failed_to_get_preview:
        "Nid oeddem yn gallu creu rhagolwg o'r CSV a lanlwythwyd.  A yw hwn yn CSV dilys?",
      remove_error:
        "Nid oeddem yn gallu gwaredu eich ffeil a lanlwythwyd o'r gweinydd.  Aeth rhywbeth o'i le.  Rhowch gynnig arall arno",
      confirm_error:
        "Mae angen i chi gadarnhau neu wrthod y ffeil a lanlwythwyd gan ddefnyddio'r botymau ar ddiwedd y rhagolwg",
