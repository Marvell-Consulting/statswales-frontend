export default function EmptyFact({ data }) {
  return (
    <>
            ...
            <div className="govuk-error-message alert-warning">
              <h1 className="govuk-heading-xl">
                {props.data.length > 499
                  ? props.t('errors.fact_table_validation.incomplete_fact_500', {
                      count: data.length
                    })
                  : props.data
              ...
              <p className="govuk-heading-s">
                {props.t('errors.fact_table_validation.incomplete_fact_info')}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-full">
          <h2 className="govuk-heading-m">
            {props.t('errors.fact_table_validation.duplicate_fact_summary')}
          </h2>
          {props.data && (
            <>
                ...
                <details className="govuk-details" data-module="govuk-details">
                  <summary className="govuk-details__summary">
                    {data.length > 499
                      ...
                      : props.t('errors.fact_table_validation.incomplete_table_summary', {
                          rows: data.length
                        })}
                  </summary>
