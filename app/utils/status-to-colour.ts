...
import { TaskListStatus } from '../../app/enums/task-list-status';
import { UserStatus } from '../../app/enums/user-status';

export const statusToColour = (
  status: TaskListStatus | DatasetStatus | PublishingStatus | UserStatus
): string => {
  switch (status) {
